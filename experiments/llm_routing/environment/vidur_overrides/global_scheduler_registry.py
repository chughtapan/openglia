from vidur.scheduler.global_scheduler.ai_global_scheduler import AIGlobalScheduler
...
GlobalSchedulerRegistry.register(GlobalSchedulerType.AI, AIGlobalScheduler)
